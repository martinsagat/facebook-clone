<template>
    <div class="bg-white h-12 px-4 flex items-center border-b border-gray-400 shadow-sm">
        <div class="md:block w-full md:w-1/3">
            <div class="flex">
                <router-link to="/">
        ...
        <div class="invisible md:visible md:w-1/3 flex justify-center items-center h-full">
        ...
        <div class="invisible md:visible md:w-1/3 md:w-1/3 flex justify-end">
        ...
        <!-- <div class="visible md:invisible md:w-1/3 md:w-1/3 flex justify-end">
